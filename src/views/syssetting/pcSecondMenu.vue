    ...
    <div class="operation">
      <div class="button">
        <el-row :gutter="10" class="operations-row">
          ...
          <span style="margin-left:10px">上级菜单：<span style="color:#409EFF">{{this.parentName}}</span></span>
        </el-row>
      </div>
      <CommonTable
        :total="total"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="父级菜单：">
         <el-input disabled v-model="parentName" placeholder="请输入菜单编码" />
        </el-form-item>
...
export default {
  ...
  mounted() {
    if (this.$route.params.code) {
      localStorage.setItem("menupcCode", this.$route.params.code);
      localStorage.setItem("menupcName", this.$route.params.name);
      ...
      this.params.parentCode = localStorage.getItem("menupcCode");
      this.parentCode = localStorage.getItem("menupcCode");
       this.parentName = localStorage.getItem("menupcName");
    }
    this.getList();
  },
  methods: {
