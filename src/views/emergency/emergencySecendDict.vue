    ...
    <div class="operation">
      <div class="button">
        <el-row :gutter="10" class="operations-row">
          ...
          <span style="margin-left:10px">上级告警类型：<span style="color:#409EFF">{{this.parentName}}</span></span>
        </el-row>
      </div>
      <CommonTable
        :total="total"
...
export default {
  ...
  mounted() {
    if (this.$route.params.code) {
      localStorage.setItem("emergencySecendCode", this.$route.params.code);
      localStorage.setItem("emergencySecendName", this.$route.params.name);
      ...
      this.params.parentCode = localStorage.getItem("emergencySecendCode");
      this.parentCode = localStorage.getItem("emergencySecendCode");
       this.parentName = localStorage.getItem("emergencySecendName");
    }
    this.getList();
  },
  methods: {
